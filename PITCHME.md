...
[02-100_基調講演_Pythonで切り開く新しい農業(小池 誠) - YouTube](https://www.youtube.com/watch?v=0bTPOsVvG7g)
...
[Pythonでライブをしよう -FoxDotを使った新時代のPython活用法-](https://pycon.jp/2019/schedule?sessionId=209)

- ライブコーディングで音楽を奏でる話。何を言っているのか（ポルナレフAA）
- 実際に見てもらった方がいいです。
- FoxDotの独自な構文（っぽい）、実は特殊メソッドでオーバーライドすることで実現される
...
研究室の学生さんが来られてたのでブース見たりコミュニティの方とお会いしたりでした！

見れなかったセッションはYoutubeで観れる。いい時代🥳
